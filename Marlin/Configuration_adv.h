...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 60 } // Feedrates for manual moves along X, Y, Z, E from panel // default 50*60, 50*60, 4*60, 60
